...
cn <- c("Operation Size", "Beekeepers [n]", "Colonies [n]", "Mean [EUR]", "Median [EUR]")
tab <- kable(
...
cn <- c("Certified Organic", "Beekeepers [n]", "Colonies [n]", "Mean [EUR]", "Median [EUR]")
tab <- kable(
...
cn <- c("Migratory Beekeeper", "Beekeepers [n]", "Colonies [n]", "Mean [EUR]", "Median [EUR]")
tab <- kable(
