...
```{r distr-year, out.width="80%", include=T, messages=F, warnings=F, fig.cap="Disitrubtion of the expenses for each survey year, values above 50 are not visible."}
