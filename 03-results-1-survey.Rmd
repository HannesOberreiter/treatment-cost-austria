...
The reported expenses per colony arithmetic mean (EUR&nbsp;`r paste(range(r_survey$summary$survey_table$mean), collapse = "-")`) and median (EUR&nbsp;`r paste(range(r_survey$summary$survey_table$median), collapse = "-")`) is similar between the three survey years (Table&nbsp;\@ref(tab:central)). The arithmetic mean is higher than the median, due to the right skewed data distribution with some high values above EUR&nbsp;100 (Fig.&nbsp;\@ref(fig:distr-year)). The distribution density of the reported expenses are similar between the three survey years and show that participant did answer in round full numbers eg. EUR&nbsp;5.00, 10.00, 15.00 (Fig.&nbsp;\@ref(fig:distr-year)).


(ref:distr-year) Distribution of the expenses for each survey year, values above EUR&nbsp;50 are not visible. First graph column represents the actual data points, second column a boxplot with median and interquantile range (IQR, $25^{th}$ - $75^{th}$ quantile) and vertical lines 1.5*IQR. Last column is density distribution of the data points. Different years are colour coded (orange = 2018/19, green = 2019/20, blue = 2020/21).
