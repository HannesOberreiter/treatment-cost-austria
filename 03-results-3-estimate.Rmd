...
c <- glue::glue("Top 11 most used treatment method combination for all three survey years. Total and percent correspond to participants (n={nrow(dfClean) %>% ft()}). Mean and median expenses from the survey and in comparison to the calculated estimate in Euro.")
