...
source("partials/r-factor.R",            local = knitr::knit_global())
source("partials/r-extrapolation.R",     local = knitr::knit_global())
source("partials/r-loss-expenses.R",     local = knitr::knit_global())
...
kable(
  STATS_operation_size$Summary[,-2], booktabs = T,
  col.names = colNames,
  digits = 2,
  align = c("c", rep("r", 4)),
  caption = c
...
kable(
  STATS_certorg$Summary[,-2], booktabs = T,
  col.names = colNames,
  digits = 2,
  align = c("c", rep("r", 4)),
  caption = c
...
Treatment Methods not used certified organic beekeeper: `r  STATS_certorg$treatments`
...
kable(
  STATS_migratory$Summary[,-2], booktabs = T,
  col.names = colNames,
  digits = 2,
  align = c("c", rep("r", 4)),
  caption = c
...
Treatment Methods not used migratory beekeeper: `r STATS_migratory$treatments`
