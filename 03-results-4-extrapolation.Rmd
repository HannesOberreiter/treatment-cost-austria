...
c <- "Multiplication of the average treatment expenses per colony with the total number of honey bee colonies wintered from the survey participants and extrapolation for Austria with the number of colonies as reported from the austrian beekeepers federation 'Biene Österreich'. Column 'Real Sum' is the observed total sum from the survey, where the total expenses for each participant was calculated by reported expenses multiplied by colonies going into winter and afterwards summarised for each year. Confidence intervals for point estimates are calculated with 1,000 bootstrap resamples. Two methods applied arithmetic mean and geometric mean."
