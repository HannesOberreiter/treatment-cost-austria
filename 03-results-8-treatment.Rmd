...
The intermediate observed mean loss rate of the treatment combinations, which is the inner quantile range of 33-67%, was in 2018/19 `r fr(r_treatment$quantile[1,2][[1]])`-`r fr(r_treatment$quantile[1,3][[1]])`%, in 2019/20 `r fr(r_treatment$quantile[2,2][[1]])`-`r fr(r_treatment$quantile[2,3][[1]])`% and in 2020/21 `r fr(r_treatment$quantile[3,2][[1]])`-`r fr(r_treatment$quantile[3,3][[1]])`% (Fig.&nbsp;\@ref(fig:efficient-economic), blue dashed vertical lines). The same range for the mean expenses of the combinations was in 2018/19 EUR&nbsp;`r fr(r_treatment$quantile[1,4][[1]])`-`r fr(r_treatment$quantile[1,5][[1]])`, in 2019/20 EUR&nbsp;`r fr(r_treatment$quantile[2,4][[1]])`-`r fr(r_treatment$quantile[2,5][[1]])` and in 2020/21 EUR&nbsp;`r fr(r_treatment$quantile[3,4][[1]])`-`r fr(r_treatment$quantile[3,5][[1]])` (Fig.&nbsp;\@ref(fig:efficient-economic), blue dashed horizontal lines).

Over the three survey years there were 17 different treatment method combinations (without drone brood removal) which had in sum at least 30 participants employing it (Table&nbsp;\@ref(tab:ee-table)). The most common treatment combination is long term formic acid in summer followed by oxalic acid trickling in winter (**A** 'SU-Fa-LT & WI-Ox-pure'). It showed in one year an intermediate loss rate and in the first two years a lower loss rate compared to the intermediate range. As for expenses the combination was categorized in two years as high expense category and only in one year in the intermediate category. In comparison the same combination but with formic acid short term application (**E** 'SU-Fa-ST & WI-Ox-pure') showed in the last two years a higher than intermediate loss rate and in the first year an intermediate categorized loss rate. The expenses category was different in each year. The sole application of formic acid long term method in summer, without winter treatment, was categorized as high expense in each year and in the first two years the loss rate was higher than the intermediate range (**M** 'SU-Fa-LT').
...
The treatment combination of oxalic acid sublimation in summer and winter (**F** SU-Ox-sub & WI-Ox-sub) was in the first year categorized as low loss rate and in the following two years as intermediate category. In addition the expenses were in each year lower than the intermediate range.
