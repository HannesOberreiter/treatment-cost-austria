...
The treatment combination of oxalic acid sublimation in summer and winter (**F** SU-Ox-sub & WI-Ox-sub) was categorized as low loss rate in the first year and as intermediate category in the following two years. In addition the expenses were lower than the intermediate range in each year.
