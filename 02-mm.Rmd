...
As it is still common to underlay the results with statistics tests, I will report the *p*-values from the median difference between given groups based on permutation generated null distribution (5,000 permutations). For the median point estimate is also a confidence interval (95%) calculated based on 1,000 bootstrap resamples. The visual difference and null distribution from the permutation test is attached in the appendix section.
