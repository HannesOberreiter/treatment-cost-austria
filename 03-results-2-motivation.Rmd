...
```{r motivation-state, include=T, messages=F, warnings=F, fig.cap="Top five motivation answers for choosing varroa control method. Stacked bar plot, representing answers for each state in Austria in relative amount to the total answers for this motivation question. Numbers in bars are in relative number of answers in procent. White background numbers indicate highest and lowest state for given motivation answer."}
