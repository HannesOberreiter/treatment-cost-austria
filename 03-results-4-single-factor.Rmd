...
```{r size-distr, include=T, fig.cap="(ref:size-distr)", out.width="80%"}
...
```{r size-stats, include=T, fig.cap="(ref:size-stats)", out.width="80%"}
...
```{r organic-stats, include=T, fig.cap="(ref:organic-stats)", out.width="80%"}
...
```{r migratory-stats, include=T, fig.cap="(ref:migratory-stats)", out.width="80%"}
