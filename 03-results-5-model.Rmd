...
```{r model-pred, include=T, fig.cap="Converted log to normal estimate and standard error as dot-and-whisker plot of the best model regression coefficients without intercept. Coefficients ordered by estimate value. Color coded if regression direction is negative (green) or positive (red).", out.width="100%"}
